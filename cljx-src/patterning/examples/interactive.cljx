(ns patterning.examples.interactive
  (:require [patterning.maths :as maths] 
            ...
            [patterning.layouts :refer [clock-rotate stack flower-of-life-positions nested-stack 
                                        place-groups-at-positions framed grid-layout]]
...
(defn _diamonds [shrink] (scale 0.9
                     (nested-stack
...
(def flower (over-style {:color (p-color 240 200 180) :fill (p-color 200 150 100)} design-language/flower ))
